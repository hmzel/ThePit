...
public enum Ministreaks {
    ...
    R_AND_R(BEASTMODE, 3, "R&R", GOLDEN_CARROT, 3, 40, 4000,
            "§7Every: §c3 kills",
            " ",
            "§7Gain §9Resistance I §7and",
            "§cRegen II §7for 3s."
    ),
    ARQUEBUSIER(null, 3, "Arquebusier", ARROW, 0, 50, 5000,
            "§7Every: §c3 kills",
            " ",
            "§7Gain:",
            "§7■ §6+7g",
    ...
    KHANATE(HIGHLANDER, 3, "Khanate", GOLDEN_HELMET, 7, 60, 6000,
            "§7Every: §c3 kills",
            " ",
            "§7Earn §6+8g§7.",
            " ",
    ...
    LEECH(MAGNUM_OPUS, 3, "Leech", CHICKEN_SPAWN_EGG, 10, 70, 6000,
            "§7Every: §c3 kills",
            " ",
            "§7Next hit heals for §c0.5❤ §7+",
            "§c20% §7of its damage."
    ),
    TOUGH_SKIN(BEASTMODE, 5, "Tough Skin", LEATHER_CHESTPLATE, 3, 30, 3000,
            "§7Every: §c5 kills",
            " ",
            "§7Receive §9-3% §7damage.",
            "§7Stacks up to §9-24%§7."
    ),
    FIGHT_OR_FLIGHT(null, 5, "Fight or Flight", FIRE_CHARGE, 0, 50, 5000,
            "§7Every: §c5 kills",
            " ",
            "§7If below half §c❤§7:",
    ...
    PUNGENT(HERMIT, 5, "Pungent", FERMENTED_SPIDER_EYE, 4, 70, 9000,
            "§7Every: §c5 kills",
            " ",
    ...
    HEROS_HASTE(null, 5, "Hero's Haste", ENCHANTED_BOOK, 0, 100, 15000,
            "§7Every: §c5 kills",
            " ",
            "§7Gain §eSpeed II §7for 5 seconds."
    ),
    RUSH(HIGHLANDER, 5, "Rush", SUGAR, 7, 110, 25000,
            "§7Every: §c5 kills",
            " ",
            "§7Gain §e1.5% Speed§7.",
            "§7Max §e+15% Speed§7."
    ),
    FEAST(null, 7, "Feast", MUTTON, 0, 30, 4000,
            "§7Every: §c7 kills",
            " ",
    ...
    COUNTER_STRIKE(null, 7, "Counter-Strike", IRON_HORSE_ARMOR, 0, 40, 5000,
            "§7Every: §c7 kills",
            " ",
            "§7Deal §c+15% damage §7and block",
            "§91❤ §7per hit for 8s."
    ),
    GOLD_NANO_FACTORY(HIGHLANDER, 7, "Gold Nano-factory", GOLD_NUGGET, 7, 50, 6000,
            "§7Every: §c7 kills",
            " ",
    ...
    TACTICAL_RETREAT(BEASTMODE, 7, "Tactical Retreat", GRASS, 3, 50, 5000,
            "§7Every: §c7 kills",
            " ",
            "§7Gain §cRegeneration IV §7and",
            "§cWeakness IV §7for 5 seconds."
    ),
    GLASS_PICKAXE(HERMIT, 7, "Glass Pickaxe", DIAMOND_PICKAXE, 4, 60, 6000,
            "§7Every: §c7 kills",
            " ",
    ...
    ASSURED_STRIKE(MAGNUM_OPUS, 7, "Assured Strike", COOKED_RABBIT, 10, 80, 10000,
            "§7Every: §c7 kills",
            " ",
    ...
    AURA_OF_PROTECTION(HERMIT, 10, "Aura of Protection", SLIME_BALL, 4, 50, 8000,
            "§7Every: §c10 kills",
            " ",
    ...
    ICE_CUBE(HERMIT, 10, "Ice Cube", PACKED_ICE, 4, 60, 9000,
            "§7Every: §c10 kills",
            " ",
    ...
    SUPER_STREAKER(TO_THE_MOON, 10, "Super Streaker", BREAD, 15, 80, 20000,
            "§7Every: §c10 kills",
            " ",
            "§7Gain §b+50 XP§7.",
            " ",
    ...
    GOLD_STACK(TO_THE_MOON, 10, "Gold Stack", GOLD_ORE, 15, 90, 25000,
            "§7Every: §c10 kills",
            " ",
    ...
    XP_STACK(TO_THE_MOON, 10, "XP Stack", DIAMOND_ORE, 15, 90, 25000,
            "§7Every: §c10 kills",
            " ",
    ...
    MONSTER(BEASTMODE, 25, "Monster", APPLE, 3, 40, 10000,
            "§7Every: §c25 kills",
            " ",
            "§7Gain an extra max §c❤ §7(max 2)."
    ),
    SPONGESTEVE(null, 25, "Spongesteve", SPONGE, 0, 70, 12000,
            "§7Every: §c25 kills",
            " ",
            "§7Gain §615❤ Absorption§7."
    ),
    APOSTLE_TO_RNGESUS(MAGNUM_OPUS, 25, "Apostle to RNGesus", QUARTZ_SLAB, 10, 100, 50000,
            "§7Every: §c25 kills",
            " ",
    ...
    UNSET(null, 0, "unset", GOLD_BLOCK, 13131313, 0, 0,
    ...
    Ministreaks(StreakBundles bundle, int trigger, String name, Material material, int prestige, int level, int cost, String... lore) {
        this.bundle = bundle;
